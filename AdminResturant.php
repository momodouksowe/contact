...
<head>
   ...
   function Edit(obj){
	...
	function gotContacts(c) {
		...
		<body>
			...
			<div data-role="header" style="text-shadow: none;">
				...
				<a href="Admin.php" data-role="button" data-icon="back" data-iconpos="notext" style="background: white;border: none;">Back</a>
			</div><!-- /header -->
	...
	<div data-role="page" id="edit">
			<div data-role="header" style="text-shadow: none; background: green">
				<h1>Edit Records</h1>
